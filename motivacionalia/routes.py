...
@router.get("/teste", response_model=dict)
...
async def create_motivational_message(request: MotivationalMessageRequest) -> MotivationalMessageResponse:
    try:
        ...
        raise HTTPException(status_code=400, detail=f"Erro ao criar mensagem motivacional: {str(e)}")